        ...
        isMobile ?
            <Fade>
                ...
                <div className="descricao-bio pl-4 font-small">
                    ...
                    E há 2 anos criei o 1º tratamento de Vaginismo à distância do mundo, ajudando <strong>mais de 700 mulheres a se livrar do Vaginismo</strong> sem sair de casa e de vários lugares do mundo.
                    <br /><br />
                        ...
                        <div className="flex relative">
                            <div className="flex flex-col w-full pl-8 md:pl-32">
                                ...
                                <div className="flex-col descricao-bio pb-20">
                                    ...
                                    <br /><br />
                                    Há mais de 7 anos trabalho com mulheres com dor durante a relação sexual.
                                    E há 2 anos <br />criei o 1º tratamento de Vaginismo à distância do mundo, ajudando <strong>mais de 700 mulheres<br /> a se livrar do Vaginismo</strong> sem sair de casa e de vários lugares do mundo.
                                    <br /><br />
                                    Diariamente compartilho muito conhecimento e qualidade de vida com milhares de
